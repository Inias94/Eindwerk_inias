...
urlpatterns = [
    ...
    # Product
    path('products/', ProductListView.as_view(), name='products'),  # This only gives the products of the user
    ...
    # ProductDish
    path('product_dish/<int:pk>/update/', ProductDishUpdateView.as_view(), name='product_dish_update'),
    path('product_dish/<int:pk>/delete/', ProductDishDeleteView.as_view(), name='product_dish_delete'),

    # Shoppinglist
    path('shoppinglist', ShoppingListListView.as_view(), name='shoppinglist'),
    path('shoppinglist/create/', ShoppingListCreateView.as_view(), name='shoppinglist_create'),
    path('shoppinglist/<int:pk>/update', ShoppingListUpdateView.as_view(), name='shoppinglist_update'),
